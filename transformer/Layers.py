...
class FFTBlock(torch.nn.Module):
    ...
    def __init__(self, d_model, n_head, d_k, d_v, d_inner, kernel_size, cln=False, dropout=0.1):
        super(FFTBlock, self).__init__()
        self.slf_attn = MultiHeadAttention(n_head, d_model, d_k, d_v, cln, dropout=dropout)
